...
> 
> For example, if you want to use **RS41 alongside SI4732 and SSB**, you can compile the firmware with the following command (which disables basic features like DTMF, Flashlight, UART, etc.):
> ```bash
