...
| **Short press `*`** | **Save Preset Screen** (Use `<` / `>` to browse list, `MENU` to confirm save, `1`-`9` to jump, `EXIT` to cancel). |
| **F + 0** | **Load Preset Screen** (Use `<` / `>` to browse list, `MENU` to confirm load, `1`-`9` to jump, `EXIT` to cancel). |
