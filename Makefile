...
ENABLE_DOCK 		          ?= 0
ENABLE_CUSTOM_SIDEFUNCTIONS   ?= 0  # disabled: free flash for CW decoder
ENABLE_SIDEFUNCTIONS_SEND     ?= 0  # disabled: free flash for CW decoder
ENABLE_BLOCK                  ?= 0
ENABLE_TURN ?=0  # disabled: free flash for CW decoder
# ---- DEBUGGING ----
ENABLE_AM_FIX_SHOW_DATA       ?= 0
ENABLE_AGC_SHOW_DATA          ?= 0
ENABLE_TIMER		          ?= 0
VSCODE_DEBUG				   = 0
ENABLE_WARNING 				  ?= 0  # disabled: free flash for CW decoder
ENABLE_MESSENGER              			= 0
...
full:
	$(RM) *.bin
	$(MAKE) build ENABLE_CHINESE_FULL=0 ENABLE_ENGLISH=1 ENABLE_FMRADIO=1 ENABLE_MESSENGER=1 ENABLE_MESSENGER_DELIVERY_NOTIFICATION=1 ENABLE_MESSENGER_NOTIFICATION=1 ENABLE_SPECTRUM=1 ENABLE_MDC1200=0 ENABLE_MDC1200_EDIT=0 ENABLE_MDC1200_CONTACT=0
	$(MAKE) build ENABLE_CHINESE_FULL=4 ENABLE_ENGLISH=1 ENABLE_DOPPLER=1 ENABLE_SPECTRUM=1 ENABLE_FMRADIO=1 ENABLE_MDC1200=0 ENABLE_MDC1200_EDIT=0 ENABLE_MDC1200_CONTACT=0
	$(MAKE) build ENABLE_CHINESE_FULL=0 ENABLE_SPECTRUM=1 ENABLE_FMRADIO=1 ENABLE_MDC1200=0 ENABLE_MDC1200_EDIT=0 ENABLE_MDC1200_CONTACT=0
	$(MAKE) build ENABLE_CHINESE_FULL=4 ENABLE_DOPPLER=1 ENABLE_SPECTRUM=1 ENABLE_FMRADIO=1 ENABLE_MDC1200=0 ENABLE_MDC1200_EDIT=0 ENABLE_MDC1200_CONTACT=0
	$(MAKE) build ENABLE_CHINESE_FULL=4 ENABLE_DOPPLER=1 ENABLE_PINYIN=1 ENABLE_SPECTRUM=1 ENABLE_FMRADIO=1 ENABLE_NO_CODE_SCAN_TIMEOUT=0 ENABLE_AM_FIX=0 ENABLE_MDC1200=0
	$(MAKE) build ENABLE_CHINESE_FULL=4 ENABLE_PINYIN=1 ENABLE_4732=1 ENABLE_4732SSB=1 ENABLE_SPECTRUM=1 ENABLE_NO_CODE_SCAN_TIMEOUT=0 ENABLE_AM_FIX=0 ENABLE_MDC1200=0
